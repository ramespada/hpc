...
Comunmente denominámos *Unidad de Procesamiento Central* (**CPU**) al conjunto de la CU, ALU y una pequeña porción de memoria rápida (registros y cache).

## Computadoras paralelas (*clusters*)

Las computadoras paralelas no son más que un conjunto de Memorias y CPUs dispuestas conectadas en una red de forma inteligente. Hay dos tipos básicos de arquitecturas de computadoras paralelas (*clusters*):
 1. Clusters de memoria distribuida (*shared memory*).
 2. Clusters de memoria compartida (*distributed memory*).
...
El primer paso en todo programa paralelo es descomponer el problema en pedazos discretos de trabajo que puede ser distribuido a distintos *tasks*.
